...
class AboutSymbols < Neo::Koan
  ...
  # ANSWER:
  # If we were to use a symbol, it would be created and added to 
  # the `Symbol.all_symbols` array. This expression would always 
  # return true, regardless of whether the symbol was declared beforehand.
  ...
  # ANSWER:
  # Perhaps because a large number of symbols utilizes a lot of memory
end
