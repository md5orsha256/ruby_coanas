...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # ANSWER:
    # `inject` is a function similar to `reduce` in other languages like 
    # python or JavaScript. This function applies a block of code to the 
    # accumulator and each element of the sequence. As an argument, the 
    # function takes the start state of the drive.
  end
  ...
  # ANSWER:
  # I think this is due to the fact that the first method allows you not 
  # to worry about explicitly closing the file, but does it automatically. 
