...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # ANSWER:
    # Depends on what you call "fail to match?". If counted as returning 
    # nil - most likely never. Anyway, I couldn't do it using the correct syntax.
  end
  ...
  # ANSWER:
  # A character class is a set of characters, a group is a mechanism that provides 
  # additional features, such as accessing it from other parts of the expression or 
  # from outside
